...
function reduceCriterionForResponse(criterion, type = null) {
  ...
  return {
    ...
    label: criterion.label,
    priority: criterion.priority,
    qualityLevel: criterion.qualityLevel || null,
    uiSeverity: criterion.uiSeverity || null,
    openDataRelevant: Boolean(criterion.openDataRelevant),
    domainCriterionIds: criterion.domainCriterionIds || [],
