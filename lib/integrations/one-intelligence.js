    ...
    messages: [
      {
        ...
        content: [
          ...
          'Antworte nur als JSON: {"terms":["..."],"types":["POI|Tour|Hotel|Event|Gastro|Package"],"categories":["..."]}.',
          'categories enthaelt ausdrücklich genannte touristische Kategorien wie Museum. terms enthaelt kurze deutsche Suchwoerter und keine Fuellwoerter.'
        ].join(' ')
      },
